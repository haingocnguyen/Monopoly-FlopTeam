...
public class GamePanel extends JPanel implements Runnable{
    // SCREEN SETTINGS
    final int originalTileSize = 15; // 15x15 Tile, 15 pixel
    final int scale = 4; // We create 15 pixel, but it will scale it to 60 pixel on the screen
    public final int tileSize = originalTileSize * scale; // The size on the screen currently is 60 pixels // This is the size of Player
    public final int CardNormalSize = tileSize + 10; // 70 pixels
    public final int CardCornerSize = tileSize + 40; // 100 pixels
    ...
    public final int screenWidth = (tileSize * 2) * maxScreenCol; // 1920 pixels width
    public final int screenHeight = (tileSize * 2) * maxScreenRow; // 1080 pixels height
